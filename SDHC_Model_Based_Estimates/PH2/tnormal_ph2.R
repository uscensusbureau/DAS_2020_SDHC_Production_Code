...
# Cell Name
# 1    Total
# 2    In Married Couple Household
# 3    Opposite-sex married couple
# 4    Same-sex married couple
# 5    In cohabiting couple household
# 6    Opposite-sex cohabiting couple
# 7    Same-sex cohabiting couple
# 8    Male householder, no spouse or partner present
# 9    Living alone
# 10   Living with others
# 11   Female householder, no spouse or partner present
# 12   Living alone
# 13   Living with others
#
# Usage: Rscript tnormal_ph2.R
...
# internal cells
src_cells = list(3:4, 6:7, 9:10, 12:13, c(3:4, 6:7, 9:10, 12:13))
# marginal cells
dest_cells = list(2, 5, 8, 11, 1)
