...
def a(*text, href=None, attrib: Dict = {}, **kwargs):
    ...
    if href:
        attrib['href'] = href
    return TyTag(TAG_A).a(*text, attrib=attrib, **kwargs)
...
def demo1() -> tydoc:
    ...
    elem = ET.fromstring("<html><p>First Paragraph</p><p>Second <b>bold</b> Paragraph</p></html>")
    doc = tydoc()
    doc.p(elem)
    return doc
...
def demo2() -> tydoc:
    elem = ET.Element("html")
    ET.SubElement(elem, 'p').text = "First Paragraph"
...
def main(showcase_enabled: bool=False) -> None:
