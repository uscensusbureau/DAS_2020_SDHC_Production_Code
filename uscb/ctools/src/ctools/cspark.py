...
def spark_submit(*, logLevel: str = None, files_to_zip: List[str] = [], pyfiles: List[str] = [], pydirs: List[str] = [],
                 ...
                 properties_file: str = None, argv, custom_app_cmd=None) -> bool:
...
def spark_session(*, logLevel=None, pyfiles=[], pydirs=[], num_executors=None,
                  files_to_zip=[],
                  conf=[], configdict={},
                  properties_file=None, appName='spark',custom_app_cmd=None):
    ...
    if not spark_running():
        ...
        spark_submit(logLevel=logLevel,
                     ...
                     argv=sys.argv,  custom_app_cmd=custom_app_cmd)
